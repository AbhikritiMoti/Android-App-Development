...
//            Toast.aqmakeText(this, "Updated $updatedName $updatedPhone", Toast.LENGTH_SHORT).show()
            ...
            builder.setPositiveButton("Edit",
                DialogInterface.OnClickListener{
                    ...
                    GlobalScope.launch {
                        database.ContactDAO().
                        update(Contact(id,updatedName,
                            updatedPhone))
                    }
                    Toast.makeText(this, "Updated $updatedName" +
                            " $updatedPhone",
            ...
            builder.setNeutralButton("Delete", DialogInterface.OnClickListener {
                ...
                val updatePhone = phoneView.text.toString().toLong()

                GlobalScope.launch {
                    database.ContactDAO()
                        .delete(Contact(id, updateName, updatePhone))
                }
            })
